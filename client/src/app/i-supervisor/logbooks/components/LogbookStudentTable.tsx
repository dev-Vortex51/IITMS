...
import { ActionMenu, AtlassianTable } from "@/components/design-system";
    ...
    <AtlassianTable
      ...
      columns={[
        ...
        },
        {
          ...
          header: "Reviewed",
          sortable: true,
          sortAccessor: (student) => student.reviewed || 0,
          render: (student) => (
            <span className="text-sm font-medium text-foreground">{student.reviewed || 0}</span>
          ),
        },
        {
          id: "actions",
            ...
            <ActionMenu
              items={[
                ...
                },
                {
                  ...
                  href: `/i-supervisor/students/${getStudentId(student)}`,
                },
              ]}
            />
          ),
