...
import { Building, Search, Eye, Mail, Users, Plus } from "lucide-react";
import Link from "next/link";
import { useState } from "react";

export default function DepartmentalSupervisorsPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage departmental supervisors and their assignments
          </p>
        </div>
        <Button disabled>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Find supervisors by name, email, or department
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-accent-foreground">
              {
                supervisors.filter(
                  (s: any) => !s.students || s.students.length === 0
                ).length
              }
            </div>
          </CardContent>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Button asChild variant="outline" size="sm">
                        <Link
                          href={`/coordinator/departmental-supervisors/${supervisor._id}`}
                        >
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  {searchQuery
                    ...
                    : "Departmental supervisors will appear here once added"}
                </p>
              </div>
            </div>
          </CardContent>
